...
export const HomePage = () => {
    ...
    return (
        <>
            <div className="flex flex-col items-start h-full w-2/3 rounded-lg p-10 gap-4 border">
                <div style={{ fontSize: "24px", fontWeight: "500", padding: "8px" }}>
                    Add Products 
                </div>

                <div className="flex justify-between w-full">
                    <div className="flex-8 font-500 pl-8">Product</div>
                    <div className="flex-2 font-500">Discount</div>
                </div>

                <div className="flex items-center text-3xl flex-col w-full p-4 gap-2 overflow-auto rounded-lg" style={{ justifyContent: products.length ? "" : "center", }}>
                    {products.length ? (
                                                    ...
                                                    <>
                                                        <div ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps} className="flex flex-col text-base gap-2 items-end rounded-lg justify-between" style={{ ...provided.draggableProps.style }}>
                                                            <Products
                                                                ...
                                                                index={index}
                                                            />
                                                            {/* View Variants toggle (only if more than 1 variant) */}
                                                            {variants.length > 1 && (
                                                            ...
                                                            {/* Variants Drag and Drop
                                                                - If only 1 variant: always show it
                                                                - If multiple variants: show when expanded
                                                            */}
                                                            {(variants.length === 1 || expandedProducts[id]) && (
